...
def main():
    ...
    # movie_matrix.csv: ohne Titel
    movies = movies.drop(columns=["title"])
    os.makedirs("/opt/airflow/data/processed", exist_ok=True)
    movies.to_csv("/opt/airflow/data/processed/movie_matrix.csv", index=False)
    user_matrix.to_csv("/opt/airflow/data/processed/user_matrix.csv")
